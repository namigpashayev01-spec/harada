            ...
            {categories.map((item) => (
              <SwiperSlide key={item.id} className="!w-auto">
                <Link
                  ...
                  className="group flex w-[88px] flex-col items-center gap-2.5 select-none">
                  <div className="relative h-[88px] w-[88px] overflow-hidden rounded-full bg-orange-soft ring-1 ring-black/5 transition-transform duration-300 group-hover:scale-105 group-hover:ring-brand">
                    <Image
