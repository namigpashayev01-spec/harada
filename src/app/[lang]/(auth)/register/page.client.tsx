...
const BANNER: Record<string, { welcome: string; tagline: string }> = {
  az: {
    welcome: "Aramıza qoşulun",
    tagline:
      "Bakının ən yaxşı restoranlarını kəşf edin və bir neçə kliklə masanızı rezerv edin.",
  },
  en: {
    welcome: "Join us",
    tagline:
      "Discover the best restaurants in Baku and book your table in just a few clicks.",
  },
  ru: {
    welcome: "Присоединяйтесь",
    tagline:
      "Откройте лучшие рестораны Баку и забронируйте столик в несколько кликов.",
  },
};
